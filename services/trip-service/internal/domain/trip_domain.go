...
type TripService interface {
	...
	GetUserRideFare(ctx context.Context, userID string, rideFareId string) (*RideFareModel, error)
}

type TripFareService interface {
	EstimatePackagesPrice(distanceInKm float64, duration float64) []*RideFareModel
